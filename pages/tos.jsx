export default function Tos() {
    return (
      <div>
       <h2 className="mt-4 text-white font-bold text-3xl">Terms of Services | Goldfish</h2>
        <p className="text-sm text-white/30 mb-1">Last Update: 06/19/2024 🆕️</p>
    <div className="animateHeader text-white text-opacity-40 mt-5">
  <p>⊳ Every discord server can use the Stylar for free, it is completely prohibited to sell or market for a fee.</p>
